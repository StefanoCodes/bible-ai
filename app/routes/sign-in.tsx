...
import { SignInSchema, type SignInRequest } from "~/lib/zod/auth/auth";
								...
								<div className="flex flex-col gap-8">
									<div className="flex flex-col gap-6">
										...
										<div className="text-right">
											<Link
												to="/forgot-password"
												className="text-amber-800 text-sm hover:text-amber-900 hover:underline"
											>
												Forgot password?
											</Link>
										</div>
